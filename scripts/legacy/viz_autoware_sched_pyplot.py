...
if __name__ == '__main__':
    ...
    data_path = os.path.dirname(os.path.realpath(__file__))[0:-7] + "data/221012_synthetic_task.json"
    ...
    e2e_response_time_path = '/home/hayeonp/git/Autoware_Analyzer/files/response_time/system_instance.csv' 
